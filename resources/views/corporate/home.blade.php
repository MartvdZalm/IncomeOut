        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div class="text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    @auth
                        <a href="{{ route('dashboard') }}" class="bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 dark:hover:bg-gray-700 transition duration-200">
                            Go to Dashboard
                        </a>
                    @else
                        <a href="{{ route('register') }}" class="bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 px-8 py-3 rounded-lg font-semibold hover:bg-blue-50 dark:hover:bg-gray-700 transition duration-200">
                            Try It Free
                        </a>
                        <a href="{{ route('about') }}" class="bg-blue-700 dark:bg-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-600 dark:hover:bg-blue-500 transition duration-200">
                            Learn More
                        </a>
                    @endauth
                </div>
