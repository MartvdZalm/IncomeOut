        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div class="flex gap-2">
                    <button onclick="document.getElementById('addTransactionModal').classList.remove('hidden')" class="bg-blue-600 dark:bg-blue-500 hover:bg-blue-700 dark:hover:bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium">
                        + Add Transaction
                    </button>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-700 p-4">
                <form method="GET" action="{{ route('transactions.index') }}" class="flex flex-wrap gap-4">
                    <div class="flex-1 min-w-[200px]">
                        ...
                        <input type="text" id="filter_search" name="search" value="{{ $searchTerm ?? '' }}" placeholder="Search by description..." class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400">
                    </div>
                    <div class="flex-1 min-w-[200px]">
                        <x-input-label for="filter_account" value="Account" />
                        <select id="filter_account" name="account_id" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400">
                    ...
                    <div class="flex items-end">
                        ...
                        <a href="{{ route('transactions.index') }}" class="ml-2 px-4 py-2 bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-200 rounded-md hover:bg-gray-400 dark:hover:bg-gray-500 text-sm">Clear</a>
                    </div>
                </form>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-700 overflow-hidden">
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <div class="mt-6">
                            <button onclick="document.getElementById('addTransactionModal').classList.remove('hidden')" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600">
                                Add Transaction
                            </button>
                        </div>
                    </div>
