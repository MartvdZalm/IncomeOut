    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-orange-100 text-lg">
                            Calculate your take profit, stop loss, position sizing, and trading fees
                        </p>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- Crypto Tools Card -->
                <a href="{{ route('crypto.tools') }}"
                    class="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-700 p-6 hover:shadow-lg transition transform hover:scale-105">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                                Calculate TP/SL, fees, position sizing, and more
                            </p>
                        </div>
                    </div>
                </a>
            ...
            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
                <div class="flex items-start">
                    <svg class="w-6 h-6 text-blue-600 dark:text-blue-400 mt-1 mr-3 flex-shrink-0" fill="none"
                    ...
                    <div>
                        ...
                        <p class="text-sm text-blue-800 dark:text-blue-200">
                            Use the trading calculators to plan your trades effectively. Calculate take profit and stop
                            loss levels based on your desired profit and trading fees, determine optimal position sizing
                            and understand the impact of fees on your trades.
                        </p>
                    </div>
                </div>
            </div>
