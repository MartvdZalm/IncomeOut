        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-700 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <x-form.input id="entry_price" label="Entry Price" type="number" step="0.00000001"
                            placeholder="0.00000000" />

                        <x-form.input id="desired_profit" label="Desired Profit (USD)" type="number" step="0.01"
                            placeholder="0.00" />

                        <x-form.input id="position_size" label="Position Size (Amount)" type="number" step="0.00000001"
                            placeholder="0.00000000" />

                        <x-form.input id="risk_reward" label="Risk / Reward Ratio" type="number" step="0.1"
                            placeholder="2" />

                        <x-form.input id="maker_fee" label="Maker Fee (%)" type="number" step="0.001" value="0.1"
                            placeholder="0.1" />

                        <x-form.input id="taker_fee" label="Taker Fee (%)" type="number" step="0.001" value="0.1"
                            placeholder="0.1" />

                        <button onclick="calculateTPSL()"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-700 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <x-form.input id="account_balance" label="Account Balance (USD)" type="number" step="0.01"
                            placeholder="10000.00" />

                        <x-form.input id="risk_percentage" label="Risk Per Trade (%)" type="number" step="0.1"
                            value="1" placeholder="1" />

                        <x-form.input id="entry_price_size" label="Entry Price" type="number" step="0.00000001"
                            placeholder="0.00000000" />

                        <x-form.input id="stop_loss_price" label="Stop Loss Price" type="number" step="0.00000001"
                            placeholder="0.00000000" />
                    ...
                    <div class="space-y-4">
                        ...
                        <div
                            ...
                            <p id="position_value" class="text-xl font-semibold text-gray-700 dark:text-gray-300">-
                            </p>
                        ...
                        <div
                            ...
                            <p id="risk_amount" class="text-xl font-semibold text-orange-600 dark:text-orange-400">-
                            </p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md dark:shadow-gray-700 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <x-form.input id="trade_amount" label="Trade Amount (USD)" type="number" step="0.01"
                            placeholder="1000.00" />

                        <x-form.input id="fee_rate" label="Fee Rate (%)" type="number" step="0.001"
                        ...
                        <x-form.input id="price_change" label="Exit Price Change (%)" type="number" step="0.1"
