        ...
        <div class="mt-3">
            ...
            <form action="{{ route('recurring-transactions.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <select id="recurring_type" name="type"
                ...
                <div>
                    ...
                    <x-text-input id="recurring_description" name="description" type="text" class="mt-1 block w-full"
                        placeholder="e.g., Salary, Rent" required />
                </div>
                <div>
                    <x-input-label for="recurring_amount" value="Amount" />
                    <x-text-input id="recurring_amount" name="amount" type="number" step="0.01" min="0.01"
                        class="mt-1 block w-full" required />
                </div>
                <div>
                    <x-input-label for="recurring_account" value="Account (optional)" />
                    <select id="recurring_account" name="account_id"
                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-indigo-500 dark:focus:ring-indigo-400">
                ...
                <div>
                    ...
                    <x-text-input id="recurring_start_date" name="start_date" type="date" class="mt-1 block w-full"
                ...
                <div id="day_of_month_field" style="display: none">
                    ...
                    <x-text-input id="recurring_day_of_month" name="day_of_month" type="number" min="1"
                        max="31" class="mt-1 block w-full" />
                </div>
                <div>
